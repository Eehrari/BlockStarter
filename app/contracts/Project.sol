...
contract Project {
    ...
    modifier onlyAllowedBacker() {
        require (fundings[msg.sender].exists && !fundings[msg.sender].claimed); _;
    }
    // Circute breaker or Emergency stop
    modifier campaignOpen() {
        require (!goalReached); _;
    }
    // Circute breaker or Emergency stop
    ...
    modifier goalNotMet() {
        require (!goalReached && now >= deadline); _;
    }
